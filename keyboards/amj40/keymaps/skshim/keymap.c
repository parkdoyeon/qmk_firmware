...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_VIMKEY] = KEYMAP( \
		...
		_______, KC_BSLS,  KC_QUOT, KC_MINS , KC_EQL,  XXXXXXX, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,  _______,  \
		XXXXXXX, KC_WH_L, XXXXXXX, KC_WH_R,  XXXXXXX,  XXXXXXX,  KC_MUTE,  KC_VOLD,  KC_VOLU,  XXXXXXX,  XXXXXXX, \
		XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN1, XXXXXXX, _______, XXXXXXX, KC_TRNS \
		),
    ...
    [_ENTKEY] = KEYMAP( \
		...
		_______, LSFT(KC_BSLS), LSFT(KC_QUOT), LSFT(KC_MINS) , LSFT(KC_EQL),  XXXXXXX, KC_LEFT, KC_DOWN, KC_SCLN, KC_QUOT,  _______,  \
		XXXXXXX, KC_WH_L, XXXXXXX, KC_WH_R,  XXXXXXX,  XXXXXXX,  KC_MUTE,  KC_VOLD,  KC_VOLU,  XXXXXXX,  XXXXXXX, \
		XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN1, XXXXXXX, _______, XXXXXXX, KC_TRNS \
		),
